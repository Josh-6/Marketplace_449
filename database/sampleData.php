<?php
    ...
    $query = "INSERT INTO Marketplace.Item (Item_ID, Seller_ID, Cart_ID, Item_Name, Item_Description, Item_Price, Item_Tags, Item_Quantity, Added_On)
        ...
        (11, 2, NULL, 'Wooden table', 'Solid wood dining table', 300.00, 'Furniture', 5, CURRENT_TIMESTAMP),
        (12, 1, NULL, 'Organic Bananas', 'Fresh organic bananas', 30.00, 'Food', 80, CURRENT_TIMESTAMP)
        ;"
        ;
